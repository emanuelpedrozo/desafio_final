...
df = spark.read.csv(
    "s3://datalake-emanuel-pucminas-923161516116/titanic/", 
    header=True, schema=schema, sep=";"
)

print("Writing titanic dataset as a delta table...")
df.write.format("delta").mode("overwrite").save("s3://datalake-emanuel-pucminas-923161516116/titanic/")
...
old = DeltaTable.forPath(spark, "s3://datalake-emanuel-pucminas-923161516116/titanic")
...
(
    ...
    .load("s3://datalake-emanuel-pucminas-923161516116/titanic")
