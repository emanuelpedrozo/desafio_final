...
def indicadores_titanic():
    ...
    def emr_create_cluster():
        cluster_id = client.run_job_flow( # Cria um cluster EMR
            Name='Automated_EMR_Emanuel',
            ServiceRole='EMR_DefaultRole',
            JobFlowRole='EMR_EC2_DefaultRole',
            VisibleToAllUsers=True,
            LogUri='s3://aws-logs-923161516116-us-east-1/elasticmapreduce/',
            ...
            Instances={
                ...
                'Ec2KeyName': 'emanuel_aws',
                'KeepJobFlowAliveWhenNoSteps': True,
                'TerminationProtected': False,
                'Ec2SubnetId': 'subnet-00b8a748daa6efde2'
            },
            ...
            Steps=[
                {
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                ...
                                's3://datalake-emanuel-pucminas-923161516116/titanic/titanic_example_delta.py'
                                ]
                    }
                }
            ]
